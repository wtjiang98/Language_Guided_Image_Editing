...
#--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 12 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn --continue_train


# MYV2FusionInpaintV0Skip0V3Refine_Simple!
...
# Simple_reduce_sum: 只用中间的一层做retouch
#python train.py \
#--name LGIEv4_pattn_VGG1_l10_lang256_MYV2FusionInpaintV0Skip0V3Batch_Simple --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 1 --batchSize 28 --nThreads 5 --lang_dim 256 \
#--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 12 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn


# LGIEv4_pattn_VGG1_l10_lang256_MYV2FusionInpaintV0Skip0V3Refine_SimpleV1!
# Simple_reduce_sum: 只用中间的一层做retouch
#python train.py \
#--name LGIEv4_pattn_VGG1_l10_lang256_MYV2FusionInpaintV0Skip0V3Refine_SimpleV1 --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3SimpleV1 --gpu_ids 0 --batchSize 20 --nThreads 5 --lang_dim 256 \
#--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 12 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn
...
# Simple_reduce_sum: 只用中间的一层做retouch
#python train.py \
#--name FiveK_pattn_VGG1_l10_lang256_MYV2FusionInpaintV0Skip0V3Batch_Simple --dataset_mode fivek  \
#--image_dir /mnt/data1/jwt/LGIE-dataset/FiveK_for_zip/images --anno_path /mnt/data1/jwt/LGIE-dataset/FiveK_for_zip/FiveK.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 3 --batchSize 28 --nThreads 5 --lang_dim 256 \
#--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 12 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn
...
#--image_dir /mnt/data1/jwt/LGIE-dataset/FiveK_for_zip/images --anno_path /mnt/data1/jwt/LGIE-dataset/FiveK_for_zip/FiveK.json \
#--netG MYV2FusionInpaintV0Skip0V3SimpleFiveK --gpu_ids 2,3 --batchSize 54 --nThreads 10 --lang_dim 256 --display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 12 \
#--lang_encoder bilstm --use_pattn --lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 \
#--norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn


# MYV2FusionInpaintV0Skip0V3Simple all_request
# Simple_reduce_sum: 只用中间的一层做retouch
#python train.py \
#--name LGIEv4_pattn_VGG1_l10_lang256_MYV2FusionInpaintV0Skip0V3BatchSimpleRefine_allreq --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 1 --batchSize 24 --nThreads 5 --lang_dim 256 \
#--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 12 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn --all_request


# MYV2FusionInpaintV0Skip0V3Refine_SimpleSigmoid
# 把spade_attn的激活函数换成Sigmoid！值域变成[0, 1]
#python train.py \
#--name LGIEv4_pattn_VGG1_l10_lang256_MYV2FusionInpaintV0Skip0V3BatchRefine_SimpleSigmoid --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 2 --batchSize 20 --nThreads 5 --lang_dim 256 \
...
# MYV2FusionInpaintV0Skip0V3Refine_SimpleSigmoidV1  WoIRD 没有IRD
# spade里用tanh，然后在W上加一个sigmoid就好
#python train.py \
#--name LGIEv4_pattn_VGG1_l10_lang256_MYV2FusionInpaintV0Skip0V3BatchRefine_WoIRD --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 3 --batchSize 20 --nThreads 5 --lang_dim 256 \
#--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 10 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade
