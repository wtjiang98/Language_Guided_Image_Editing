...
#--ground_gt --use_expert --exclude_colorbg --filter_req expert_excolorbg


#python wjy_tools.py \
#--name wjy_tools --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 0 --batchSize 20 --nThreads 8 --lang_dim 256 \
#--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 1 --lang_encoder bilstm --use_pattn \
...
#--session 3 --id wjy_test --print_freq 100 --load_checkpoint /mnt/data1/jwt/LGIE/output/IER_ground_trial_1/best_dict.pth --learning_rate 0.0 --gpuid 0 \
#--ground_gt
...
--netG MYV2FusionInpaintV0Skip0V3SimpleFiveK --gpu_ids 3 --batchSize 20 --nThreads 8 --lang_dim 256 --display_freq 3000 --lambda_unchange 0.0 \
--niter 100 --save_epoch_freq 1 --lang_encoder bilstm --use_pattn --lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 \
--lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn --print_freq 100