...
#python train_all_fixground.py \
#--name check_wjy_all_fixground_2 --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 1 --batchSize 2 --nThreads 5 --lang_dim 256 \
#--display_freq 100 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 10 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn \
#--session 3 --id wjy_test --print_freq 10 --load_checkpoint /mnt/data1/jwt/LGIE/output/IER_ground_trial_1/best_dict.pth --learning_rate 0.0

#python train_all_fixground.py \
#--name check_wjy_all_fixground_MYV2FusionInpaintV0Skip0V3SimpleALL_new --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3SimpleALL --gpu_ids 1 --batchSize 20 --nThreads 5 --lang_dim 256 \
#--display_freq 100 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 10 --lang_encoder bilstm --use_pattn \
#--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn \
#--session 3 --id wjy_test --print_freq 10 --load_checkpoint /mnt/data1/jwt/LGIE/output/IER_ground_trial_1/best_dict.pth --learning_rate 0.0 --gpuid 1
...
#--name inference_ground_MYV2FusionInpaintV0Skip0V3SimpleALL --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
...
#--name check_fixground --dataset_mode my --label_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/masks \
#--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
#--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 2 --batchSize 20 --nThreads 8 --lang_dim 256 \
...
--image_dir /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/images --anno_path /mnt/data1/jwt/LGIE-dataset/IER2_for_zip_final/learnable_op_v1.json \
--label_nc 8 --no_instance --contain_dontcare_label --netG MYV2FusionInpaintV0Skip0V3Simple --gpu_ids 2 --batchSize 20 --nThreads 8 --lang_dim 256 \
--display_freq 3000 --lambda_unchange 0.0 --niter 100 --save_epoch_freq 1 --lang_encoder bilstm --use_pattn \
--lambda_vgg 1 --lambda_gan 0 --lambda_L1 10.0 --lambda_feat 0 --lambda_gan_uncond 0 --norm_G spectralspadebatch1x1 --encoder_nospade --spade_attn \
--session 3 --id wjy_test --print_freq 100 --load_checkpoint /mnt/data1/jwt/LGIE/output/IER_ground_trial_1/best_dict.pth --learning_rate 0.0 --gpuid 2 \
--ground_gt --use_expert --filter_req expert
