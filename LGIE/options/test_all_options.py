...
class TestALLOptions(BaseOptions):
  def initialize(self, parser):
    ...
    parser.add_argument('--session', type=int, default=3, required=True,
                        help='session for the setting of the experiment.')
    ...
    parser.add_argument('--train_loss_threshold', type=float, default=None,
                        help='save model when train loss is smaller than this threshold')
